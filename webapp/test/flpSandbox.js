		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Contacts Worklist App",
									"targetURL": "#ContactsWorklistApp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ContactsWorklistApp-display": {
								"semanticObject": "ContactsWorklistApp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ui5contacts",
									"url": sap.ui.require.toUrl("ui5contacts")
								}
							}
						}
					}
